...
window.EDL_I18N = {
  en: {
    ...
    "testi.title": "Trusted by practices across Maryland",
       ...
       "testi.q1": "Elite has been our lab for years. The fit and esthetics are consistently excellent — crowns come back right the first time, and our patients notice the difference.",
    ...
    "about2.ownerEyebrow": "Founder & Owner",
    "about2.ownerBio1": "Ivan Zaprianov is a master dental technician with more than 30 years of experience in dental prosthetics. Educated in Dental Prosthetics in Bulgaria, he has refined his craft working across three countries — Bulgaria, Spain and the United States — bringing together European artistry and American digital innovation.",
    "about2.ownerBio2": "That international perspective shapes everything the lab produces: restorations built with old-world attention to detail and finished with the latest digital precision.",
    "about2.labTitle": "The Lab",
    "about2.labP1": "Elite Dental Lab is a full-service lab located in Cockeysville, Maryland (Baltimore County). It specializes in a variety of products and services including, but not limited to: full-contour dental crowns and bridges, porcelain-fused-to-zirconia crowns and bridges, high-translucency anterior crowns, and implant restorations with custom abutments or screw-retained crowns — and much more.",
    "about2.labP2": "The mission behind the lab is to simplify treatments and optimize results in restoring patients' healthy, natural-looking smiles.",
    "about2.labP3": "For the past 25 years, Elite Dental Lab has been a customer-driven resource, committed to delivering superior quality products, innovative solutions, and unmatched service satisfaction. That's why Elite Dental Lab has become such a respected asset to many dental professionals throughout the region.",
   ...
   "faq.title": "Frequently asked questions",
    ...
    "pw.ruleVariety": "Contains upper case, lower case, a number and a symbol",
  ...
  es: {
    ...
    "testi.title": "La confianza de clínicas en todo Maryland",
       ...
       "testi.q1": "Elite ha sido nuestro laboratorio durante años. El ajuste y la estética son consistentemente excelentes — las coronas llegan bien a la primera, y nuestros pacientes notan la diferencia.",
    ...
    "about2.ownerEyebrow": "Fundador y Propietario",
    "about2.ownerBio1": "Ivan Zaprianov es un maestro técnico dental con más de 30 años de experiencia en prótesis dental. Formado en Prótesis Dental en Bulgaria, ha perfeccionado su oficio trabajando en tres países — Bulgaria, España y Estados Unidos — uniendo el arte europeo con la innovación digital americana.",
    "about2.ownerBio2": "Esa perspectiva internacional define todo lo que produce el laboratorio: restauraciones elaboradas con la atención al detalle del viejo mundo y terminadas con la más moderna precisión digital.",
    "about2.labTitle": "El Laboratorio",
    "about2.labP1": "Elite Dental Lab es un laboratorio de servicio completo ubicado en Cockeysville, Maryland (condado de Baltimore). Se especializa en una variedad de productos y servicios que incluyen, entre otros: coronas y puentes dentales de contorno completo, coronas y puentes de porcelana fundida sobre zirconia, coronas anteriores de alta translucidez, y restauraciones sobre implantes con pilares personalizados o coronas atornilladas — y mucho más.",
    "about2.labP2": "La misión del laboratorio es simplificar los tratamientos y optimizar los resultados para devolver a los pacientes sonrisas sanas y de aspecto natural.",
    "about2.labP3": "Durante los últimos 25 años, Elite Dental Lab ha sido un recurso orientado al cliente, comprometido con entregar productos de calidad superior, soluciones innovadoras y una satisfacción de servicio inigualable. Por eso Elite Dental Lab se ha convertido en un activo tan respetado para muchos profesionales dentales de la región.",
   ...
   "faq.title": "Preguntas frecuentes",
    ...
    "pw.ruleVariety": "Contiene mayúsculas, minúsculas, un número y un símbolo",
  ...
  de: {
    ...
    "testi.title": "Das Vertrauen von Praxen in ganz Maryland",
       ...
       "testi.q1": "Elite ist seit Jahren unser Labor. Passform und Ästhetik sind durchgehend exzellent — die Kronen passen beim ersten Mal, und unsere Patienten merken den Unterschied.",
    ...
    "about2.ownerEyebrow": "Gründer & Inhaber",
    "about2.ownerBio1": "Ivan Zaprianov ist Zahntechnikermeister mit über 30 Jahren Erfahrung in der Zahnprothetik. Ausgebildet in Zahnprothetik in Bulgarien, hat er sein Handwerk in drei Ländern verfeinert — Bulgarien, Spanien und den USA — und verbindet europäische Handwerkskunst mit amerikanischer digitaler Innovation.",
    "about2.ownerBio2": "Diese internationale Perspektive prägt alles, was das Labor fertigt: Restaurationen mit der Detailtreue der alten Schule, vollendet mit modernster digitaler Präzision.",
    "about2.labTitle": "Das Labor",
    "about2.labP1": "Elite Dental Lab ist ein Komplettservice-Labor in Cockeysville, Maryland (Baltimore County). Es ist auf eine Vielzahl von Produkten und Leistungen spezialisiert, unter anderem: vollanatomische Kronen und Brücken, keramisch verblendete Zirkonkronen und -brücken, hochtransluzente Frontzahnkronen sowie Implantatversorgungen mit individuellen Abutments oder verschraubten Kronen — und vieles mehr.",
    "about2.labP2": "Die Mission des Labors: Behandlungen vereinfachen und Ergebnisse optimieren, um Patienten gesunde, natürlich wirkende Lächeln zurückzugeben.",
    "about2.labP3": "Seit 25 Jahren ist Elite Dental Lab eine kundenorientierte Anlaufstelle, die sich höchster Produktqualität, innovativen Lösungen und einem unübertroffenen Service verschrieben hat. Deshalb ist Elite Dental Lab für viele Zahnärzte der Region ein so geschätzter Partner geworden.",
   ...
   "faq.title": "Häufig gestellte Fragen",
    ...
    "pw.ruleVariety": "Enthält Groß- und Kleinbuchstaben, eine Zahl und ein Symbol",
